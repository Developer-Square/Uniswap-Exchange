...
const Exchange = ({ pools }) => {
  ...
  const fromValueIsGreaterThanZero = fromValueBigNumber.gt(parseUnits('0'));
  ...
  const onFromValueChange = (value) => {
    ...
    try {
      ...
      console.log(`Error from onFromValueChange: ${error}`);
    }
  };
